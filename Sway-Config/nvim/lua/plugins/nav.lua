return {
  ...
  -- Transparent bar with Kanagawa accents
  -- ========================================
 {
  ...
  config = function()
    require("bufferline").setup({
      ...
      -- We remove the 'colors' table and use dynamic highlights
      highlights = {
        fill = { bg = "none" },
        background = { bg = "none" },
        
        -- Selected tab: Links to 'TabLineSel' or 'CursorLine' 
        -- so it matches whatever theme you switch to
        buffer_selected = {
          bold = true,
          italic = true,
        },
        
        -- Make separators transparent to match your UI
        separator = { bg = "none" },
